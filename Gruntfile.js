...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      compileCore: {
        ...
        src: 'less/<%= themeName %>.less',
        dest: 'dist/css/<%= themeName %>.css'
      ...
      compileTheme: {
        ...
        src: 'less/theme.less',
        dest: 'dist/css/<%= themeName %>-theme.css'
    ...
    autoprefixer: {
      ...
      theme: {
        ...
        src: 'dist/css/<%= themeName %>-theme.css'
    ...
    cssmin: {
      ...
      minifyCore: {
        src: 'dist/css/<%= themeName %>.css',
        dest: 'dist/css/<%= themeName %>.min.css'
      },
      minifyTheme: {
        src: 'dist/css/<%= themeName %>-theme.css',
        dest: 'dist/css/<%= themeName %>-theme.min.css'
      },
      docs: {
        src: [
  ...
  grunt.registerTask('distDirty', ['dist-css']); // distDirty task. 3.3.6
  ...
  grunt.registerTask('default', function()
  {
    ...
    grunt.task.run('dist-css'/*, 'csslint'*/, 'distDirty', 'copy:fonts');
  });
